data = {
    ...
    mobs: {
        ...
        necromancer: {type: "mob", avatar: "NEC", max_hp: 150, hp: 150, name: "magic staff", description: "A necromancer. She summons ghosts and dead stuff.", drops: [{"candiesConverter": 1}, {"object": "cauldron", 1}]},
        ...
        knight: {type: "mob", avatar: "KNI", max_hp: 70, hp: 70, name: "sharp sword", description: "A knight with a huge armor.", drops: [{"candies": [230, 70+230]}, {"plateArmour": (1/10})]},
        ...
        tree: {type: "mob", avatar: "|||", max_hp: 5, hp: 5, name: "none", description: "A tree. It sometimes drops a candy.", drops: [{"candies": [0, 1]}, {"key": (1/2})]},
        ...
        basicChest: {type: "mob", avatar: "CHS", max_hp: 80, hp: 80, name: "none", description: "A chest !! Very rare.", drops: [{"candies": [300, 500+300]}, {"key": 1}, {"object": "boots", (1/3}), {"object": "swampMap", (1/3}), {"object": "hutMap", (1/3})]},
        ...
        theWhale: {type: "mob", avatar: "The Whale.", max_hp: 100, hp: 100, name: "giant tail", description: "The Whale does not like to be disturbed.", drops: [{"candies": [400, 400+400]}, {"key": 1}, {"object": "hutMap", 1}, {"object": "swampMap", 1}, {"object": "boots", 1}, {"object": "wellMap", 1}, {"object": "magicianHat", 1}, {"object": "pinkRing", 1}, {"object": "forgeMap", 1}]},
        ...
        tenaciousGoblin: {type: "mob", avatar: "GTB", max_hp: 30, hp: 30, name: "dagger", description: "A tenacious goblin. Oh, he has a dagger, too.", drops: [{"candies": [9, 9+9]}, {"key": (1/2}), {"object": "boots", (1/5}), {"object": "swampMap", (1/5}), {"object": "hutMap", (1/5})]},
        ...
        irc: {type: "ally", avatar: "ORC", max_hp: 30, hp: 30, name: "bludgeon", description: "An orc. It looks stupid.", drops: []},
